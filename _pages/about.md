...
- [WiGRUNT: WiFi-enabled gesture recognition using dual-attention network](https://ieeexplore.ieee.org/abstract/document/9759238), Yu Gu, **Xiang Zhang\***, Yantong Wang, Meng Wang, Huan Yan, Yusheng Ji, Zhi Liu, Jianhua Li, Mianxiong Dong, **IEEE THMS 2022, Andrew P. Sage Best Transactions Paper Award** `CCF B, SCI Q3, IF = 3.5`
